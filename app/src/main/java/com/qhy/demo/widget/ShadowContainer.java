...
//        int shadowColor = Color.RED;
        mShadowRadius = a.getDimension(R.styleable.ShadowContainer_containerShadowRadius, 0);
        ...
        mDx = a.getDimension(R.styleable.ShadowContainer_deltaX, 0);
        mDy = a.getDimension(R.styleable.ShadowContainer_deltaY, 0);
        ...
        mShadowPaint.setShadowLayer(mShadowRadius, mDx, mDy, shadowColor);
    }


    public void setShadowColor(@ColorInt int color) {
        mShadowPaint.setShadowLayer(mShadowRadius, mDx, mDy, color);
    }

...
public final class AppManager {
    ...
    private boolean DEPENDENCY_SUPPORT_DESIGN = findClassByClassName("android.support.design.widget.Snackbar");
    ...
    /**
     * 让在前台的 {@link Activity}, 使用 Snackbar 显示文本内容
     *
     * @param message
     * @param isLong
     */
    public void showSnackbar(final String message, boolean isLong) {
        if (getCurrentActivity() == null && getTopActivity() == null) {
            Log.w("showSnackbar", "mCurrentActivity == null when showSnackbar(String,boolean)");
            return;
        }
    ...
    public void killAll() {
        synchronized (AppManager.class) {
            ...
            while (iterator.hasNext()) {
                ...
                iterator.remove();
                next.finish();
                Logs.e("finish Activity: " + next.getLocalClassName());
            }
        }
    }
